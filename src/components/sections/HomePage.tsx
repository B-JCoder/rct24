...
const processSteps = [
  ...
  },
  {
    ...
    image: "/images/step-contents-cleaning.png",
  },
  {
    step: "03",
    ...
    image: "/images/step-restoration-rebuild.png",
  },
  {
    step: "04",
    ...
    image: "/images/step-pre-plan.png",
  },
];
...
const heroSlides = [
  "/images/hero-disaster-mitigation.png",
...
export function HomePage() {
  ...
  useEffect(() => {
    const slideDurations = [2000, 2000, 2000, 3000];
    ...
    <div className="rct-page">
      ...
      <section id="home" className="rct-hero">
        <div className="rct-hero-photos" aria-hidden="true">
          {heroSlides.map((image, index) => (
            <div
              key={image}
              className={`rct-hero-photo${index === currentSlide ? " active" : ""}`}
              style={{
      ...
      <section id="about" className="rct-section">
        ...
        <div className="rct-stats">
          {stats.map(([value, label], idx) => (
            <ScrollReveal direction="up" delay={idx * 100} key={value}>
              <div className="rct-glass-card">
                <strong>{value}</strong>
                <span>{label}</span>
              </div>
            </ScrollReveal>
      ...
      <section id="services" className="rct-section">
        ...
        <div className="rct-services">
          {services.map((service, idx) => (
            <ScrollReveal direction="up" delay={idx * 100} key={service.title}>
              <article className="rct-service-card">
                <div className="rct-service-img-wrapper">
      ...
      <section id="process" className="rct-section rct-section-alt">
        ...
        <div className="rct-process-grid">
          {processSteps.map((step, idx) => (
            <ScrollReveal direction="up" delay={idx * 100} key={step.step}>
              <div className="rct-process-card">
                <div
                  className="rct-process-card-bg"
                  style={{ backgroundImage: `url("${step.image}")` }}
                />
                <div className="rct-process-card-content">
      ...
      <section id="why" className="rct-section rct-why">
        ...
        <div className="rct-process">
          ...
          {["Emergency", "Contents", "Restoration", "Pre-Plan"].map((item, idx) => (
            <ScrollReveal direction="right" delay={(idx + 1) * 100} key={item}>
              <div className="rct-glass-card">
                <strong>{item}</strong>
      ...
      <section id="testimonials" className="rct-section rct-section-alt">
        ...
        <div className="rct-testimonials">
          {testimonials.map((t, idx) => (
            <ScrollReveal direction="up" delay={idx * 100} key={t.name}>
              <div className="rct-testimonial-card">
      ...
      <section id="team" className="rct-section">
        ...
        <div className="rct-team-grid">
          {teamMembers.map((member, idx) => (
            <ScrollReveal direction="up" delay={idx * 80} key={member.name}>
              <div className="rct-team-card">
      ...
      <section id="gallery" className="rct-section rct-section-alt">
        ...
        <div className="rct-gallery-grid">
          {galleryImages.map((img, idx) => (
            <ScrollReveal direction="up" delay={idx * 60} key={img.title}>
              <div className="rct-gallery-item">
      ...
      <section id="faqs" className="rct-section">
        ...
        <div className="rct-faq-list">
          {faqs.map((faq, i) => (
            <ScrollReveal direction="up" delay={i * 60} key={i}>
              <div
